...
function FooterLink({
  ...
  return (
    <Link
      href={href}
      className="text-sm text-neutral-600 transition-colors duration-300 hover:text-neutral-900 dark:text-neutral-300 dark:hover:text-white"
    >
      {children}
    </Link>
  );
...
export function Footer() {
  ...
  return (
    <footer className="relative overflow-hidden border-t border-black/5 bg-white py-14 dark:border-white/10 dark:bg-neutral-950">
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-10 lg:grid-cols-[1.3fr_0.7fr_0.7fr_0.7fr]">
          <div>
            <Link
              href="/"
              className="inline-flex items-center gap-2 text-base font-semibold tracking-tight text-neutral-900 dark:text-white"
            >
              <span className="grid h-9 w-9 place-items-center rounded-2xl border border-black/10 bg-white/70 shadow-sm backdrop-blur dark:border-white/10 dark:bg-neutral-900/60">
                <Sparkles className="h-4 w-4 text-blue-700 dark:text-blue-300" />
              </span>
              Gulshan Sir Siksha
            </Link>

            <p className="mt-3 max-w-md text-sm leading-7 text-neutral-600 dark:text-neutral-300">
              A modern education portal experience — clean filters, premium design, and fast browsing across colleges and programs.
            </p>

            <div className="mt-6 rounded-3xl border border-black/5 bg-white/60 p-5 shadow-md backdrop-blur-xl dark:border-white/10 dark:bg-neutral-900/55">
              <div className="flex items-start gap-3">
                <span className="grid h-10 w-10 place-items-center rounded-2xl border border-black/10 bg-white/70 dark:border-white/10 dark:bg-neutral-950/60">
        ...
        <div className="mt-12 flex flex-col gap-3 border-t border-black/5 pt-6 text-sm text-neutral-500 dark:border-white/10 dark:text-neutral-400 sm:flex-row sm:items-center sm:justify-between">
