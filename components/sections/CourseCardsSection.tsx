...
function Badge({ children }: { children: string }) {
  return (
    <span className="inline-flex items-center gap-1 rounded-full border border-black/10 bg-white/70 px-2.5 py-1 text-xs font-medium text-neutral-700 backdrop-blur dark:border-white/10 dark:bg-neutral-950/60 dark:text-neutral-200">
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-8 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {courses.map((c) => (
            ...
            >
              <div className="relative overflow-hidden rounded-3xl border border-black/5 bg-white/70 shadow-md backdrop-blur-xl transition-all duration-300 ease-out group-hover:-translate-y-1 group-hover:shadow-xl dark:border-white/10 dark:bg-neutral-900/60">
                <div className="absolute inset-0">
                  <img
                    ...
                    loading="lazy"
                  />
                  <div className="absolute inset-0 bg-gradient-to-b from-white/70 via-white/45 to-white/85 dark:from-neutral-950/50 dark:via-neutral-950/65 dark:to-neutral-950/85" />
                </div>

                <div className="relative p-6">
                  <div className="flex items-center justify-between gap-3">
                    <Badge>{c.badge}</Badge>
                    <span className="rounded-full border border-black/10 bg-white/70 px-2.5 py-1 text-xs font-medium text-neutral-700 backdrop-blur dark:border-white/10 dark:bg-neutral-950/60 dark:text-neutral-200">
                      {c.duration}
                    </span>
                  </div>

                  <h3 className="mt-4 text-lg font-semibold tracking-tight text-neutral-900 dark:text-white">
                    {c.title}
                  </h3>
