...
export const metadata: Metadata = {
  title: "3-Year Courses",
  description: "Browse 3-year courses across Indian colleges with filters.",
};
...
export default async function Courses3YearsPage({
  searchParams,
}: {
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
      <div className="flex flex-col gap-6">
        ...
        <SearchBar actionPath="/courses/3-years" />
